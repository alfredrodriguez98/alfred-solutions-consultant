      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <ScrollReveal delay={0.1}>
            <h2 className="text-[clamp(34px,5vw,56px)] font-extrabold tracking-[-2px] leading-[1.05] text-foreground">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {CASE_STUDIES.map((cs, i) => (
            <ScrollReveal key={cs.title} delay={i * 0.1}>
              <div className="group h-full flex flex-col p-7 rounded-2xl border border-[var(--card-border)] bg-white dark:bg-white/[0.03] shadow-sm dark:shadow-none hover:border-accent/40 hover:shadow-md dark:hover:shadow-none dark:hover:bg-white/[0.05] transition-all duration-300">
                {/* Badge */}
                <div className="mb-5">
                ...
                {/* Title */}
                <h3 className="font-bold text-[18px] text-foreground mb-3 leading-snug tracking-tight">
                  {cs.title}
                </h3>

                {/* Description */}
                <p className="text-[14.5px] text-muted leading-relaxed flex-1 mb-6">
                  {cs.description}
                </p>

                {/* Outcome */}
                <div className="flex items-center gap-2.5 pt-5 border-t border-[var(--card-border)]">
